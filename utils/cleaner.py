...
clean_series short-circuits non-string/object dtype, converts to str (handling â€˜nanâ€™/â€˜Noneâ€™/â€˜NATâ€™ as NaN when handle_na), vectorizes the map replacements, optionally applies Unicode normalization and control-character filtering via .apply, strips special characters via regex, then trims.

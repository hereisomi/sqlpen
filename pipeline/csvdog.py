...
def csvdog(
    ...
    for csv_path in directory.glob("*.csv"):
        ...
        try:
            ...
            df, _ = sanitize_dataframe_columns(df, server=engine.dialect.name.lower(), allow_space=False, to_lower=True)
            ...
            # We enforce `schema_name=None` inside this nested runner to prevent overwriting our current `schema` loop.
